...
public class Main3 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<String>> vetPedido = Control.lerArquivo("ligamagicPedido3.txt");
        ...
        try {
            Control.gravar("C:\\xampp\\htdocs\\Projetos\\LigaMagic-Java-TCC\\pedido3.json",
                    Control.converter("Pedido 3", arrayInicioPopulacao, arraySelecao, arrayCruzamtento, arrayMutacao,
