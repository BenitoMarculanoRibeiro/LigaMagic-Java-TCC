...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<String>> vetPedido = Control.lerArquivo("ligamagicPedido2.txt");
        ...
        try {
            Control.gravar("C:\\xampp\\htdocs\\Projetos\\LigaMagic-Java-TCC\\pedido2.json",
                    Control.converter("Pedido 2", arrayInicioPopulacao, arraySelecao, arrayCruzamtento, arrayMutacao,
