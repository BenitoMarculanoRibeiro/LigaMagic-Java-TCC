...
public class Main4 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<String>> vetPedido = Control.lerArquivo("ligamagicPedido4.txt");
        ...
        try {
            Control.gravar("C:\\xampp\\htdocs\\Projetos\\LigaMagic-Java-TCC\\pedido4.json",
                    Control.converter("Pedido 4", arrayInicioPopulacao, arraySelecao, arrayCruzamtento, arrayMutacao,
